...
if __name__ == '__main__':
    ...
    print(sizes.shape)
    print("Maximum width", np.argmax(sizes[:,0]))
    print("Maximum Length", np.argmax(sizes[:,1]))
    print("Minimum Width", np.argmin(sizes[:,0]))
    print("Maximum Length", np.argmin(sizes[:,1]))
    print("Mean Length", np.mean(sizes[:,0]))
